                    ...
                    case 1: {
                        ...
                        switch (opt3) {
                            ...
                            case 1: {
                                ...
                                in.nextLine();
                                List<hust.soict.globalict.aims.media.Track> tracks = new ArrayList<>();
                                for (int i = 1; i <= numTrack; ++i) {
                                    System.out.println("Track " + i + " title:");
                                    String tempTitle = in.nextLine();
                                    System.out.println("Track " + i + " length:");
                            ...
                            case 3: {
                                ...
                                for (int i = 1; i <= numAuthor; ++i) {
                                    System.out.println("Author " + i + "'s name:");
                                    String tempTitle = in.nextLine();
            ...
            case 1: {
                ...
                switch (opt2) {
                    ...
                    case 1: {
                        ...
                        System.out.println("Total cost: " + curMedia.getCost() + "$");
                        System.out.println("************************************************");
                        System.out.println("Press Enter key to go back...");
                        try {
                            System.in.read();
